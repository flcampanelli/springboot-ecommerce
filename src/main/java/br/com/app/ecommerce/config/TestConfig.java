...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Order firstOrder = new Order(null, Instant.parse("2024-03-20T19:53:07Z"), firstUser);
        Order secondOrder = new Order(null, Instant.parse("2024-04-21T03:42:10Z"), secondUser);
        Order thirdOrder = new Order(null, Instant.parse("2024-04-27T15:21:22Z"), firstUser);
